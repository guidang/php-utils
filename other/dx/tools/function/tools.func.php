...
function save_ucserver_config($config, $file) {

	$success = false;

	list($appauthkey, $appid, $ucdbhost, $ucdbname, $ucdbuser, $ucdbpw, $ucdbcharset, $uctablepre, $uccharset, $ucapi, $ucip,$ucmykey,$uckey) = explode('|', $config);
...
function savezucconfig($zucconfig, $file) {

	$success = false;

	list($host,$zucdbusername,$zucdbpw,$zucdbname,$db_charset,$pre,$prepath,$domain,$connect,$cha,$fpw,$slt,$key,$siteid,$mykey,$debug,$app) = explode('|', $zucconfig);
...
define('UC_DBUSER', '$zucdbusername');
define('UC_DBPW', '$zucdbpw');
define('UC_DBNAME', '$zucdbname');
define('UC_DBCHARSET', '$db_charset');
define('UC_DBTABLEPRE', '$pre');
define('UC_COOKIEPATH', '$prepath');
define('UC_COOKIEDOMAIN', '$domain');
define('UC_DBCONNECT', 0);
define('UC_CHARSET', '$cha');
define('UC_FOUNDERPW', '$fpw');
define('UC_FOUNDERSALT', '$slt');
define('UC_KEY', '$key');
define('UC_SITEID', '$siteid');
define('UC_MYKEY', '$mykey');
define('UC_DEBUG', '$debug');
define('UC_PPP', 20);
?>
EOT;
